...
const Settings: React.FC = () => {
  const { settings, updateSettings, clearData } = useFinance();
    ...
    <div className="p-6 page-transition h-full flex flex-col dark:text-white text-zinc-900 pb-24">
       ...
       <div className="space-y-4">
           ...
           <div className="pt-6 space-y-3">
               <h3 className="text-xs font-bold text-zinc-400 uppercase tracking-wider px-1">Data Management</h3>
               ...
               <button 
                 ...
                 className="w-full glass-panel p-4 rounded-2xl flex items-center justify-between group active:scale-[0.98] transition-all border-red-200 dark:border-red-900/30"
               >
                   <div className="flex items-center space-x-4">
                       ...
                       <div className="text-left">
                           <span className="block font-bold text-sm text-red-600 dark:text-red-400">Erase All Content</span>
                           <span className="block text-red-400 dark:text-red-500/70 text-xs">Delete transactions, accounts & budgets</span>
                       </div>
                   </div>
               </button>
           </div>
